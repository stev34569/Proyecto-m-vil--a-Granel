...
import 'perfil_administrador_model.dart';
export 'perfil_administrador_model.dart';

class PerfilAdministradorWidget extends StatefulWidget {
  const PerfilAdministradorWidget({Key? key}) : super(key: key);

  @override
  _PerfilAdministradorWidgetState createState() =>
...
class _PerfilAdministradorWidgetState extends State<PerfilAdministradorWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PerfilAdministradorModel());
  }
