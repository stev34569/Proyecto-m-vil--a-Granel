...
import 'plantilla_prueba_model.dart';
export 'plantilla_prueba_model.dart';

class PlantillaPruebaWidget extends StatefulWidget {
  const PlantillaPruebaWidget({Key? key}) : super(key: key);

  @override
  _PlantillaPruebaWidgetState createState() => _PlantillaPruebaWidgetState();
}

class _PlantillaPruebaWidgetState extends State<PlantillaPruebaWidget> {
  late PlantillaPruebaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlantillaPruebaModel());
  }
