...
import 'chats_lista_model.dart';
export 'chats_lista_model.dart';

class ChatsListaWidget extends StatefulWidget {
  const ChatsListaWidget({Key? key}) : super(key: key);

  @override
  _ChatsListaWidgetState createState() => _ChatsListaWidgetState();
}

class _ChatsListaWidgetState extends State<ChatsListaWidget>
    with TickerProviderStateMixin {
  late ChatsListaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChatsListaModel());
                        ...
                        Builder(
                          builder: (context) {
                            ...
                            return ListView.builder(
                              ...
                              shrinkWrap: true,
                              scrollDirection: Axis.vertical,
                              itemCount: buscarDatos.length,
                              itemBuilder: (context, buscarDatosIndex) {
                                final buscarDatosItem =
                                    buscarDatos[buscarDatosIndex];
                                return Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 20.0),
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      context.pushNamed(
                                        ...
                                        queryParameters: {
                                          ...
                                          'foto': serializeParam(
                                            buscarDatosItem.photoUrl,
                                            ParamType.String,
                                          ),
                                          'name': serializeParam(
                                            buscarDatosItem.displayName,
                                            ParamType.String,
                                          ),
                                          'email': serializeParam(
                                            buscarDatosItem.email,
                                            ParamType.String,
                                          ),
                                        }.withoutNulls,
                                      );
